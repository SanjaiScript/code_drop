...
void my_wc(char* file_name, int* line_count, int* word_count, int* character_count){
    ...
    int fd; // fd for reading file descriptor

    *line_count = 0; // intialising all as zero
    *word_count = 0;
    *character_count = 0;
...
int main(int argc, char** argv) {
    ...
    int line_flag = 0 , word_flag = 0 , character_flag = 0; // creating flags

    int line_count = 0, word_count = 0 , character_count = 0; // creating count variables

    int total_line = 0 , total_word = 0 , total_character = 0; // creating total count variables

    int return_value; // for checking getopt
    ...
    if (optind >= argc) { // to check if theres no argument
